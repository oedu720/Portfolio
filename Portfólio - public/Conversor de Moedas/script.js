function showOnScreen(){
    ...
    const mySecondSelect = document.querySelector("#my-second-select")
...
unitedStatesFlag.style = "position: relative; top: 25px;"
titleDolar.style = "height: 25px; margin-top: 75px;"
currencyValueDolar.style = "margin-top: 45px;"
}